  var IS360Palyer = function(parentDomElement,videoSrc,imgPath,tipsTitle){
                // 全局变量
                ...
                var createTooltip = function(){
                    ...
                    $(divElement).append('<img src="'+imgPath+'/drag_tips.png"  style="width:100%;height:100%;"/>');
                    $(divElement).append('<span style="width:60%;position:absolute;bottom:80px;left:20%;line-height:22px;text-align:center;">'+tipsTitle+'</span>');
                ...
                var createRenderer = function(){
                    ...
                    $(parentDomElement).append('<img src="'+imgPath+'/corner_mask_LT.png"  style="position:absolute;left:0px;top:0px;" />');
                    $(parentDomElement).append('<img src="'+imgPath+'/corner_mask_RT.png"  style="position:absolute;right:0px;top:0px;" />');
                    $(parentDomElement).append('<img src="'+imgPath+'/corner_mask_RB.png"  style="position:absolute;right:0px;bottom:0px;" />');
                    $(parentDomElement).append('<img src="'+imgPath+'/corner_mask_LB.png"   style="position:absolute;left:0px;bottom:0px;" />');
                };
